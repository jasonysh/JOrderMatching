...
public class BenchmarkCollection_CancelOrder {
  ...
  public static abstract class AbstractBenchmark {
    ...
    public void bench() {
      Order o = engine.cancelOrder(currentOrder.getSymbol(), currentOrder.getSide(), Order.getOrderId(currentOrder.getSender(), currentOrder.getClientOrderId()));
      //System.out.println(o.getClientOrderId());
